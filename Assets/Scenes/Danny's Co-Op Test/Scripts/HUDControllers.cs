...
public class HUDControllers : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        {
            WeaponSwitcher inventory = GameValues.instance.getPlayer(i).GetComponentInChildren<WeaponSwitcher>(); // Danny: Change when implementing to main
            ...
            stateText[i].text = "Movement State: " + GameValues.instance.getPlayer(i).GetComponent<PlayerMovements>().currentState; // Danny: Change when implementing to main
        }
    }
